@extends('base')@section('main')<div class="row">
    <div class="col-sm-8 offset-sm-2">
        ...
        <div> @if ($errors->any()) <div class="alert alert-danger">
            ...
            </div><br /> @endif <form method="post" action="{{ route('contacts.store') }}"> @csrf <div
                    class="form-group"> <label for="first_name">First Name:</label> <input type="text"
                        class="form-control" name="first_name" /> </div>
                ...
                </div> <button type="submit" class="btn btn-primary-outline">Add contact</button>
            </form>
        </div>
    </div>
</div>@endsection